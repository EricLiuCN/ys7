...
namespace Ericliucn\Ys7;

use Ericliucn\Ys7\Model\AccessToken;
...
class Ys7Client
{
    ...
    public function getAccessToken()
    {
        ...
        //缓存永久存储，lifetime设为0
        S($cacheKey,$result['data']['accessToken'],604750);
     ...
     * @throws \think\Exception
     */
    public function getCapture($deviceSerial, $channelNo=1){
        $params = [
            'deviceSerial' => $deviceSerial,
            'channelNo' => $channelNo,
        ];
        return $this->post(self::API_ENDPOINT . '/device/capture', $params);
    }
